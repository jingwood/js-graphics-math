...
export class MathFunctions {
  ...
  static distancePointToPoint2D(p1, p2) {
    return this.distancePointToPoint2DXY(p1.x, p1.y, p2.x, p2.y);
  }

  static distancePointToPoint2DXY(p1x, p1y, p2x, p2y) {
  ...
  static distancePointToLine2DXYXY(p, x1, y1, x2, y2) {
    const a = y2 - y1,
      b = x1 - x2,
      c = x2 * y1 - x1 * y2;
  ...
  static distancePointToLineSegment2DXYXY(p, x1, y1, x2, y2) {
  ...
  static nearestPointToLineSegment2DXYXY(p, x1, y1, x2, y2) {
    // source: https://stackoverflow.com/questions/849211/shortest-distance-between-a-point-and-a-line-segment
  ...
  static triangleContainsPoint2D(v1, v2, v3, p) {
  ...
  static calcHitInterpolation(t, hit) {
    var int = MathFunctions.calcVertexInterpolation(t, hit);
...
MathFunctions.triangleIntersectBox = function() {
